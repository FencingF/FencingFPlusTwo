...
public class PopLag extends Module {
    ...
    public static final Setting<Boolean> cancelOnly = new Setting<>("CancelOnly", false);
    ...
    public void onPop(TotemPopEvent event) {
        if (getFencing().friendManager.isFriend(event.getPlayer().entityUniqueID) || event.getPlayer().equals(mc.player) || !fullNullCheck() || cancelOnly.getValue()) return;
